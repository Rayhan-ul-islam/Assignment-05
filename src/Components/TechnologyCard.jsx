        ...
        <div>
            <div className="max-w-xs p-6 bg-white border border-gray-100 rounded-3xl shadow-sm font-sans">
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <img src={tech.icon} className="w-10 h-10" viewBox="0 0 128 128" width="100%" height="100%" />
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">{tech.name}</h2>
                ...
                <button className="w-full py-3 bg-slate-950 text-white text-sm font-medium rounded-xl hover:bg-slate-800 transition-colors">
                    Add to Stack
                </button>
            </div>
        </div>
